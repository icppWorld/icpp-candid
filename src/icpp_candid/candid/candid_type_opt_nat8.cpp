...
CandidTypeOptNat8::CandidTypeOptNat8() : CandidTypeBase() {
...
bool CandidTypeOptNat8::decode_M(CandidDeserialize &de, VecBytes B,
                                 __uint128_t &offset,
...
//------------
// Initialize things
void CandidTypeOptNat8::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeOptNat8::set_datatype() {
...
void CandidTypeOptNat8::encode_T() {
...
bool CandidTypeOptNat8::decode_T(VecBytes B, __uint128_t &offset,
                                 std::string &parse_error) {
...
void CandidTypeOptNat8::encode_I() {
