...
CandidTypeVecNat32::CandidTypeVecNat32() : CandidTypeBase() {
...
void CandidTypeVecNat32::set_content_type() {
  m_content_opcode = CandidOpcode().Nat32;
  m_content_hex = OpcodeHex().Nat32;
  m_content_textual = OpcodeTextual().Nat32;
}

void CandidTypeVecNat32::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeNat32 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecNat32::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecNat32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecNat32::set_datatype() {
...
void CandidTypeVecNat32::encode_T() {
...
bool CandidTypeVecNat32::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeVecNat32::encode_I() {
