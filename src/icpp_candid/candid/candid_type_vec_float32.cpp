...
CandidTypeVecFloat32::CandidTypeVecFloat32() : CandidTypeBase() {
  std::vector<float> v;
  set_v(v);
  initialize();
}
...
void CandidTypeVecFloat32::set_content_type() {
  m_content_opcode = CandidOpcode().Float32;
  m_content_hex = OpcodeHex().Float32;
  m_content_textual = OpcodeTextual().Float32;
}

void CandidTypeVecFloat32::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeFloat32 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecFloat32::decode_M(CandidDeserialize &de, VecBytes B,
                                    __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecFloat32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecFloat32::set_datatype() {
...
void CandidTypeVecFloat32::encode_T() {
...
bool CandidTypeVecFloat32::decode_T(VecBytes B, __uint128_t &offset,
                                    std::string &parse_error) {
...
void CandidTypeVecFloat32::encode_I() {
