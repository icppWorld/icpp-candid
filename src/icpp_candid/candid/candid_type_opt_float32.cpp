...
CandidTypeOptFloat32::CandidTypeOptFloat32() : CandidTypeBase() {
...
bool CandidTypeOptFloat32::decode_M(CandidDeserialize &de, VecBytes B,
                                    __uint128_t &offset,
  ...
  if (tag == 1) {
    ...
    ICPP_HOOKS::trap(
        "ERROR: tag in opt float32 coming from wire is not 0 or 1");
  }
...
//------------
// Initialize things
void CandidTypeOptFloat32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeOptFloat32::set_datatype() {
...
void CandidTypeOptFloat32::encode_T() {
...
bool CandidTypeOptFloat32::decode_T(VecBytes B, __uint128_t &offset,
                                    std::string &parse_error) {
...
void CandidTypeOptFloat32::encode_I() {
