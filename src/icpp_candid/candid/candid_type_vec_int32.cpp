...
CandidTypeVecInt32::CandidTypeVecInt32() : CandidTypeBase() {
...
void CandidTypeVecInt32::set_content_type() {
  m_content_opcode = CandidOpcode().Int32;
  m_content_hex = OpcodeHex().Int32;
  m_content_textual = OpcodeTextual().Int32;
}

void CandidTypeVecInt32::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeInt32 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecInt32::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecInt32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecInt32::set_datatype() {
...
void CandidTypeVecInt32::encode_T() {
...
bool CandidTypeVecInt32::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeVecInt32::encode_I() {
