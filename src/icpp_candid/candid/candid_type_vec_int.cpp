...
void CandidTypeVecInt::set_content_type() {
  m_content_opcode = CandidOpcode().Int;
  m_content_hex = OpcodeHex().Int;
  m_content_textual = OpcodeTextual().Int;
}
...
bool CandidTypeVecInt::decode_M(CandidDeserialize &de, VecBytes B,
