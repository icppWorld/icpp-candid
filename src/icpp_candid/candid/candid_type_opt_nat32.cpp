...
CandidTypeOptNat32::CandidTypeOptNat32() : CandidTypeBase() {
...
bool CandidTypeOptNat32::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
//------------
// Initialize things
void CandidTypeOptNat32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeOptNat32::set_datatype() {
...
void CandidTypeOptNat32::encode_T() {
...
bool CandidTypeOptNat32::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeOptNat32::encode_I() {
