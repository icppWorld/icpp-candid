...
CandidTypeVecInt64::CandidTypeVecInt64() : CandidTypeBase() {
...
void CandidTypeVecInt64::set_content_type() {
  m_content_opcode = CandidOpcode().Int64;
  m_content_hex = OpcodeHex().Int64;
  m_content_textual = OpcodeTextual().Int64;
}

void CandidTypeVecInt64::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeInt64 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecInt64::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecInt64::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecInt64::set_datatype() {
...
void CandidTypeVecInt64::encode_T() {
...
bool CandidTypeVecInt64::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeVecInt64::encode_I() {
