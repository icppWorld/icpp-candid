...
CandidTypeVecNat64::CandidTypeVecNat64() : CandidTypeBase() {
...
void CandidTypeVecNat64::set_content_type() {
  m_content_opcode = CandidOpcode().Nat64;
  m_content_hex = OpcodeHex().Nat64;
  m_content_textual = OpcodeTextual().Nat64;
}

void CandidTypeVecNat64::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeNat64 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecNat64::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecNat64::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecNat64::set_datatype() {
...
void CandidTypeVecNat64::encode_T() {
...
bool CandidTypeVecNat64::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeVecNat64::encode_I() {
