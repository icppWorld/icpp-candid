...
CandidTypeOptInt64::CandidTypeOptInt64() : CandidTypeBase() {
...
bool CandidTypeOptInt64::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
//------------
// Initialize things
void CandidTypeOptInt64::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeOptInt64::set_datatype() {
...
void CandidTypeOptInt64::encode_T() {
...
bool CandidTypeOptInt64::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeOptInt64::encode_I() {
