...
CandidTypeOptInt32::CandidTypeOptInt32() : CandidTypeBase() {
...
bool CandidTypeOptInt32::decode_M(CandidDeserialize &de, VecBytes B,
                                  __uint128_t &offset,
...
//------------
// Initialize things
void CandidTypeOptInt32::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeOptInt32::set_datatype() {
...
void CandidTypeOptInt32::encode_T() {
...
bool CandidTypeOptInt32::decode_T(VecBytes B, __uint128_t &offset,
                                  std::string &parse_error) {
...
void CandidTypeOptInt32::encode_I() {
