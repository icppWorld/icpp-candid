...
CandidTypeVecNat8::CandidTypeVecNat8() : CandidTypeBase() {
...
void CandidTypeVecNat8::set_content_type() {
  m_content_opcode = CandidOpcode().Nat8;
  m_content_hex = OpcodeHex().Nat8;
  m_content_textual = OpcodeTextual().Nat8;
}

void CandidTypeVecNat8::push_back_value(CandidTypeRoot &value) {
  auto &derived_value = static_cast<CandidTypeNat8 &>(value);
  if (m_pv) {
    // We're deserializing
...
bool CandidTypeVecNat8::decode_M(CandidDeserialize &de, VecBytes B,
                                 __uint128_t &offset,
...
// ---------
// Initialize things
void CandidTypeVecNat8::initialize() {
  set_datatype();
  set_content_type();
  encode_T();
  encode_I();
...
void CandidTypeVecNat8::set_datatype() {
...
void CandidTypeVecNat8::encode_T() {
...
bool CandidTypeVecNat8::decode_T(VecBytes B, __uint128_t &offset,
                                 std::string &parse_error) {
...
void CandidTypeVecNat8::encode_I() {
